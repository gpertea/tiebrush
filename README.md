...
The initial goal is to generate this composite BAM file which multiplexes read alignments from many sequencing samples, painting a wide "background" picture of the expression levels of various read-alignments across those many samples.
